...
namespace UM_extension {
    ...
    inline double distance2(const UM::vec3& A, const UM::vec3& B) {
        return (A - B).norm2();
    }

    inline double point_segment_squared_distance(const UM::vec3& P, const std::array<UM::vec3, 2>& AB, UM::vec3& closest_point, std::array<double, 2>& l) {
    ...
    inline double point_triangle_squared_distance(const UM::vec3& P, const std::array<UM::vec3, 3>& ABC, UM::vec3& closest_point, std::array<double, 3>& l) {
        UM::vec3 diff = ABC[0] - P;
        UM::vec3 edge0 = ABC[1] - ABC[0];
        UM::vec3 edge1 = ABC[2] - ABC[0];
